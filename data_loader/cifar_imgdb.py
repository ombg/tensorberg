...
class ImgdbLoader:
    ...
    def __init__(self,config):
        ...
        data = data_utils.get_some_data(
            config.input_path,
            input_path_imgdb_test=config.input_path_test,
        ...
        self.train_dataset = train_dataset.shuffle(buffer_size=len(X_train))
        self.train_dataset = train_dataset.repeat().batch(args.batch_size)
